...
import vn.gmorunsystem.aimam.ui.customview.ShopHomeItemView;
...
public class HomeShopListFragment extends BaseFragment {
    ...
    ShopHomeItemView layoutItemOne;
    @BindView(R.id.rl_position_two)
    ShopHomeItemView layoutItemTwo;
    @BindView(R.id.rl_position_three)
    ShopHomeItemView layoutItemThree;
    ...
    public static HomeShopListFragment newInstance(ShopSuggestListParcel beanList, Location userLocation, boolean isPageOdd) {
    ...
    public static HomeShopListFragment newInstance(ShopAdvListParcel beanList, Location userLocation, boolean isPageOdd) {
        HomeShopListFragment fragment = new HomeShopListFragment();
        Bundle bundle = new Bundle();
