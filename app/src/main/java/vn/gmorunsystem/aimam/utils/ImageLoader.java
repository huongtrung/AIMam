...
public class ImageLoader {
    ...
    public static void loadImage(Context context, int igmResId, ImageView imageView) {
        Glide.with(context).load(igmResId).centerCrop().into(imageView);
    }
    ...
    public static void loadImageThumnail(Context context, String url, ImageView imageView) {
        Glide.with(context).load(url).thumbnail(0.3f).centerCrop().into(imageView);
    }

    public static void loadImageThumnail(Context context, int igmResId, ImageView imageView) {
        Glide.with(context).load(igmResId).thumbnail(0.3f).centerCrop().into(imageView);
    }
}
